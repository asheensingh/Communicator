...
<!DOCTYPE html>
<html lang="en">
    <head>      <!-- To create the login page of the web application of the BBD Communicator.-->
        <meta charset="UTF-8">
                ...
                <div class="col-lg-9">            
                    <div class="jumbotron">
                     ...
                     background-size:cover;">
                            ...
                            <fieldset>    
                             <input type="button" class="btn btn-primary btn-lg"  onClick="window.location = 'https://www.yammer.com/dialog/oauth?client_id=nEjhbfN94g3w2nAYczxEw&redirect_uri=http://bbdcom.herokuapp.com/scripts/login.php';" value="Login"> 
                            </fieldset>
                        </form>
                        </div>
                        </div>
